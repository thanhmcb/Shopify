...
class ProductInventory extends HTMLElement {
  ...
  updateInventory(inventory) {
    ...
    if (this.closest('.js-product').querySelector('.product-info__property')) {
      var myNode = this.closest('.js-product').querySelector('.product-info__property');
           ...
           if (b8 === 'true'){
            if (count > 1 ){ 
              ...
              if (b8Metafield === 'true'){
                ...
                var a = this.closest('.js-product').querySelectorAll('cart-message .product-info__property'); 
...
const showCartPopUp = function(){
  ...
  document.querySelector('.cart--accept').addEventListener('click', function (e) {
    document.getElementById("terms").setAttribute("checked", "true")
  });
...
const TermsAgreement = class extends HTMLElement {
  ...
  handleFormSubmittingEvent(evt) {
    if (!this.querySelector('input:checked')) {
      ...
      document.getElementById("mini-cart-terms").remove();
    }
  }
};
